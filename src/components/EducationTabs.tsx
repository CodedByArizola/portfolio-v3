                ...
                <Fade in={true} timeout={1000}>
                    <div>
                        ...
                        <Typography variant="body1" color="white">
                            Currently studying for my <span style={{ color: 'var(--main_color2_brighter)' }}>Associate of Applied Science-Transfer</span> degree within Computing and Software Development.
